...
module.exports = class {
  ...
  constructor(fragment_location_folder, max_cache_size) {
    this.fragment_cache = {}
    ...
    this.fragio = new FIO(fragment_location_folder, this);
  }
  ...
  delete_fragment(fragment) {
    ...
    delete this.fragment_cache_hits[fragment.fragment_id]
    this.delete_fragment_file_by_id(fragment.fragment_id);
  }

  delete_fragment_file_by_id(fragment_id) {
    console.log("deleting fragment", fragment_id)
